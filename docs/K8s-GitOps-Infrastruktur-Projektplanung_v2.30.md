...
## Projektplanung - Version 2.30

**Erstellt:** 04.02.2026  
**Letzte Aktualisierung:** 06.07.2026 (kube-vip API-Server-VIP Control-Plane HA DEV abgeschlossen: VIP 192.168.180.20 / k8s-dev-api.eneg.de, kube-vip v1.2.0 ARP nur-Control-Plane, tls-san-Erweiterung rolling, Failover-Test bestanden; Runbook kube-vip-api-vip.md; Voraussetzung fuer TEST-Node-Migration)  
