...
## Projektplanung - Version 2.31

**Erstellt:** 04.02.2026  
**Letzte Aktualisierung:** 06.07.2026 (Monitoring-Reaktivierung TEST: application-controller wieder hochgefahren, Prometheus/Alertmanager via Git-Haertung replicas=1; Loki TEST auf NAS20/HTTPS migriert (14b, CA-Bundle + NAS20-Credentials); Loki Retention-Enforcement via Compactor in base fuer alle Envs aktiviert (DEV+TEST ausgerollt, PROD offen); Docs: monitoring-reaktivierung-test-2026-07-06.md + phase-14 14b-Abschnitt)  
