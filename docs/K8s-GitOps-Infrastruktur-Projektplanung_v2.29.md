...
## Projektplanung - Version 2.29

**Erstellt:** 04.02.2026  
**Letzte Aktualisierung:** 03.07.2026 (vSphere/vCenter-Monitoring DEV: dedizierte Alloy-Instanz alloy-vcenter mit OTel vcenter-Receiver fuer beide vCenter (a+b), remote_write an Prometheus, VMCA-CA-Bundle, Grafana-Dashboard Hosts+Kapazitaet+Disk-Latenz DEV-only; Runbook vsphere-vcenter-exporter-alloy.md)  
