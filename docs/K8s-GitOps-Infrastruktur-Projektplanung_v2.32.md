...
## Projektplanung - Version 2.32

**Erstellt:** 04.02.2026  
**Letzte Aktualisierung:** 14.07.2026 (NAS-Reboot-Verifikation + CNPG-Backup-Cleanup: beide NAS (NAS10+NAS20) nach Zertifikatstausch/Reboot per aktivem Schreibtest ueber alle 6 CNPG-Cluster verifiziert; cnpg-erp TEST ScheduledBackup reaktiviert (suspend:false); suspend:false in DEV/TEST/PROD vereinheitlicht; doppelter monitoring-Block in TEST/PROD bereinigt; PROD cnpg-erp Recovery-Konfig entfernt (OutOfSync behoben); serverName vN (cnpg-erp-v2/cnpg-shared-v2) entfernt -> PROD an DEV/TEST angeglichen, alte S3-Ordner geloescht; Doc: incidents/2026-07-14-nas-reboot-verifikation-cnpg-backup-cleanup.md)  
